...
| Number of Bars/Liquor stores (1,3) | Bars/Liquor store per capita and per area | Open Street Map | [Bars/Liquor stores](data_final/metadata/metadata_bars_liquorstores.md) |Municipality (Olina also calculated at smaller scales)  | Complete |
...
| Volunteerism per capita |  |   |  | | *pending updated source (from UIC team) |
...
| Cultural Centers/Museum/Art Galleries | Average distance from each municipality to the nearest cultural points (cultural center, art gallery, or museum) | from the UIC team  | [Cultural distance](data_final/metadata/metadata_cultural_distance.md) | Municipality | Complete |
...
| Residential employment per capita | employment per capita (unemployment may be a better measure?) | ACS  | [Community Economy](data_final/metadata/metadata_community_econ.md) |Tract | Complete |
| Community investment |  |   |  | | *pending updated source (from UIC team) |
